...
Stone3::Stone3(std::shared_ptr<Scene> scene) : Drawable(scene)
{
...
{
    // Load model
    m_model->loadModel("./Assets/Models/Stone3.fbx", m_vertices, m_normals, m_uvs, m_indices, m_tangents, m_bitangents);
    createBuffers();
