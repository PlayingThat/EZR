...
Stone1::Stone1(std::shared_ptr<Scene> scene) : Drawable(scene)
{
...
{
    // Load model
    m_model->loadModel("./Assets/Models/Stone1.fbx", m_vertices, m_normals, m_uvs, m_indices, m_tangents, m_bitangents);
    createBuffers();
