...
Stone4::Stone4(std::shared_ptr<Scene> scene) : Drawable(scene)
{
...
{
    // Load model
    m_model->loadModel("./Assets/Models/Stone4.fbx", m_vertices, m_normals, m_uvs, m_indices, m_tangents, m_bitangents);
    createBuffers();
